...
class AddEditTaskScreenTest {
    ...
    fun registerIdlingResource() {
        Espresso.registerIdlingResources(EspressoIdlingResource.idlingResource)
    }
    ...
    fun unregisterIdlingResource() {
        Espresso.unregisterIdlingResources(EspressoIdlingResource.idlingResource)
    }
    ...
    fun toolbarTitle_newTask_persistsRotation() {
        ...
        // Rotate activity
        TestUtils.rotateOrientation(mActivityTestRule.activity)
    ...
    fun toolbarTitle_editTask_persistsRotation() {
        ...
        FakeTasksRemoteDataSource().addTasks(Task("Title1", "", TASK_ID, false))
